...
PORT=8000
3. Frontend Setup
The frontend uses the TMDB API. You might need to add your API Key in script.js if it's not hardcoded (though for this project structure, it is often inside the JS file directly).
...
Database Access: Create a database user (username and password). Remember this password!
